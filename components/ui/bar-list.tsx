// Adapted from Tremor Raw BarList [v0.1.0]
...
export type Bar<T> = T & {
    ...
    value: number
    name: string
    color?: string // Added support for custom color classes
}
                    ...
                    >
                        <div
                            className={cn(
                                ...
                                rowHeight,
                                // background color - Use item color if available, else default
                                item.color ?? "bg-blue-200 dark:bg-blue-900",
                                onValueChange && !item.color
